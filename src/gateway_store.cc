...
const discord::guild *discord::gateway_store::get_guild(discord::snowflake guild_id) const
{
...
discord::snowflake discord::gateway_store::lookup_channel(discord::snowflake channel_id) const
{
